v0.2.0, 2021-11-28 -- Refactored for entity registry and UI Integration configuration, added full support for contact sensors (as binary sensors), thermostat sensors (as sensors) and garage doors (as covers)
